...
object VSCrashReportHeader {
    ...
    private fun getHeaderComment(): String {
        return try {
            HEADER_COMMENTS[(Util.getMillis() % HEADER_COMMENTS.size.toLong()).toInt()]
        } catch (_: Exception) {
            "...oh dear."
        }
    }
    ...
    fun addCrashReportHeader(builder: StringBuilder) {
        ...
        builder.append("\nIf your issue has not been reported / you are unable to find it, or you are unsure, please report it at the link provided above.\n\n")
    }
